...
export default async function MainSection() {
  ...
  return (
    <section
      className="home-scroll-target relative mx-auto w-full max-w-[1600px] overflow-hidden px-5 py-8 sm:px-8 md:py-10 lg:px-10"
      id="inicio"
    >
      ...
      <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(320px,0.98fr)] lg:items-center">
        <HomeReveal className="flex flex-col justify-center" eager>
          ...
          <p className="mt-5 max-w-[34rem] text-lg leading-relaxed text-slate-500">
            En Peloteras puedes jugar fútbol, encontrar eventos deportivos, organizar los tuyos y
            conectar con más mujeres y personas de la diversidad.
          </p>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/events"
              className="group home-button-micro inline-flex h-12 items-center justify-center gap-2 rounded-full bg-mulberry px-7 text-sm font-semibold text-white shadow-[0_20px_40px_-30px_rgba(84,8,111,0.95)] hover:bg-[#470760]"
            >
            ...
            <OrganizerEntryLink className="group home-button-micro inline-flex h-12 items-center justify-center gap-2 rounded-full border border-slate-300 px-7 text-sm font-semibold text-slate-700 hover:border-slate-400 hover:bg-white">
              <span>Quiero organizar</span>
              <span
