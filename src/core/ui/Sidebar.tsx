...
import { ButtonM, ParagraphM, ParagraphS } from '../../../src/core/ui/Typography';
...
const Sidebar: FC<SidebarProps> = ({ features, events }) => {
  ...
  useEffect(() => {
    const newQueryString = createQueryString({
      priceRange: selectedPriceRange.priceRange?.length
        ? selectedPriceRange.priceRange.join(',')
        : null,
    });
      ...
      <div data-sticky="" data-margin-top="32" data-sticky-for="768" data-sticky-wrap="">
        <div className="relative bg-gray-50 rounded-xl border border-gray-200 p-5">
          <div className="absolute top-5 right-5 leading-none">
            <button
              className="hover:underline text-clear"
              onClick={() => {
          ...
          <div className="grid grid-cols-2 md:grid-cols-1 gap-6">
            <div>
              <div className="mb-2">
                <ParagraphM fontWeight="bold">Tipo de evento</ParagraphM>
              </div>
            ...
            <div>
              <div className="mb-2">
                <ParagraphM fontWeight="semibold">Nivel</ParagraphM>
              </div>
              <ul className="space-y-2">
                <label className="flex items-center">
                  <input
                    ...
                    className="form-checkbox text-clear h-5 w-5 border-2 border-gray-400 rounded"
                  />
                  <span className="font-poppins text-base text-gray-600 ml-2">Sin experiencia</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="form-checkbox text-clear h-5 w-5 border-2 border-gray-400 rounded"
                  />
                  <span className="font-poppins text-base text-gray-600 ml-2">Intermedio</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="form-checkbox text-clear h-5 w-5 border-2 border-gray-400 rounded"
                  />
                  <span className="font-poppins text-base text-gray-600 ml-2">Avanzado</span>
                </label>
              </ul>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 text-base font-poppins font-semibold">
                  <label className="w-full">
                    <ParagraphM fontWeight="semibold">Ubicación</ParagraphM>
                  </label>
                </div>
            ...
            <div>
              <div className="mb-4">
                <ParagraphM fontWeight="semibold">Costo</ParagraphM>
              </div>
              <ul className="space-y-2">
            ...
            <div>
              <div className="mb-4">
                <ParagraphM fontWeight="semibold">Extras</ParagraphM>
              </div>
              <ul className="space-y-2">
