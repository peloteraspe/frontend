...
export const Button: FC<ButtonProps> = ({
  ...
  return (
    <button
      className={`z-10 transition duration-150 py-[8px] text-sm w-full h-full flex items-center justify-center font-bold rounded-md focus:outline-none appearance-none ${
