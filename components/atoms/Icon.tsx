...
interface Props extends Omit<React.DetailedHTMLProps<React.SVGAttributes<SVGSVGElement>, SVGSVGElement>, 'disabled'> {
  fill: string;
...
export const Icon = forwardRef<SVGSVGElement, Props>(function Icon(props, ref) {
  const { fill, paths, width, height, ...rest } = props;
  ...
  return (
    <svg
      ...
      width={width ?? '24'}
      height={height ?? '24'}
      viewBox={width ? `0 0 ${width} ${width}` : '0 0 24 24'}
      fill='none'
